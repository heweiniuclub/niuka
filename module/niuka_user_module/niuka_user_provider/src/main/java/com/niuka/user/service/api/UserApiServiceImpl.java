...
//            }
    ...
    @Override
    public Map<String, Object> updatePassword(ExtendMap<String, Object> params) {
        Map<String, Object> result = new HashMap<String, Object>();
        try {
            // 检查参数
            if (CollectionUtils.isEmpty(params)) {
            ...
            //根据用户ID和客户ID查询客户用户记录
            //修改用户登录密码
            customerUserJtaApiService.updateUserPwd("13556631734", customerId, PasswordProvider.encrypt(rePassword));
