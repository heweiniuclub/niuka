package com.niuka.common.interceptor.mybatis;
...
public class PaginationInterceptor implements Interceptor {
    ...
    public String buildPageSql(String sql, Pagination<?> pagination) {
        ...
        pageSql.append(" LIMIT " + (pagination.getPageNo() - 1) * pagination.getPageSize() + ","
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        if (invocation.getTarget() instanceof StatementHandler) {
            ...
            Pagination<?>    pagination       = findPaginationParameter(statementHandler.getBoundSql()
                                                                                        .getParameterObject());
